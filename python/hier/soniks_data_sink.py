...
class soniks_data_sink(gr.sync_block):
    ...
    """
    def __init__(self,decoded_data_file_path="/tmp/.satnogs/data/data", sat_id="0",packet_len=132):
    ...
    def work(self, input_items, output_items):
        ...
        if(len(self.out_frame_temp_arr)==self.packet_len):
            ...
            with open(f"{self.decoded_data_file_path}_{self.sat_id}_{time_st}_g{self.x}",'wb') as out1:
