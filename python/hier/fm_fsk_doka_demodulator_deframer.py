...
class fm_fsk_doka_demodulator_deframer (gr.hier_block2):
    def __init__(self, pack_len=132, samp_rate=48000, syncword="1100010010110010001010011000010101110000011011111011110001011010", threshold=10):
        ...
        self.freq_xlating_fir_filter_xxx_1 = filter.freq_xlating_fir_filter_fcc(10, [16], 0, samp_rate)
